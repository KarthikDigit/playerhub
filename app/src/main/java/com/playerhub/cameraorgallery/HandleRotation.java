...
public class HandleRotation {

    private static final String TAG = "HandleRotation";
...
//
//        int orientation = ei.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_FLIP_HORIZONTAL);
