...
public class ChangeCreditCardWebViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackButtonEnabledAndTitle("Change Credit Card");
        setActionBarTitleBold("Change Credit Card");
...
//                if (isFirstTime)
                view.loadUrl("https://www.playerhub.io/card-update");
//                isFirstTime = false;
