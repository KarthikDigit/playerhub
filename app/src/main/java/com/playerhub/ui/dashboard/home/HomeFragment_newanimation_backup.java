...
public class HomeFragment_newanimation_backup extends BaseNetworkCheck implements ParentChildPagerAdapter.OnItemClicklistener, CardPagerAdapter.OnItemClickListener {
    ...
    public HomeFragment_newanimation_backup() {
...
//        addParentProfile();
        ...
        mFloatingMenu.setOnClickListener(new View.OnClickListener() {
            @TargetApi(Build.VERSION_CODES.LOLLIPOP)
            @Override
            public void onClick(View v) {
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(getActivity(),
                        mFloatingMenu, getString(R.string.share_transition_name));
                Intent intent = new Intent(getContext(), EventSharingActivity.class);
...
//        AnimUtils.setSlideDownAnimation(announcement_layout);
    ...
    private void setAnnouncementData(List<AnnouncementApi.Datum> upcommingEventList) {
        ...
        if (upcommingEventList != null && !upcommingEventList.isEmpty()) {
            ...
            if (profileViewPager1 != null) {
                ...
                AnimUtils.setFadeAnimationtest(announcement_layout);
            }
